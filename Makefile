project-files: cabal.8.0.2.project cabal.8.2.2.project cabal.8.4.4.project cabal.8.6.2.project
build: build-8.0.2 build-8.2.2 build-8.4.4 build-8.6.2
test: test-8.0.2 test-8.2.2 test-8.4.4 test-8.6.2
deps: deps.8.0.2.png deps.8.2.2.png deps.8.4.4.png deps.8.6.2.png
