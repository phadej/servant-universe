project-files: cabal.7.8.4.project cabal.7.10.3.project cabal.8.0.2.project cabal.8.2.2.project cabal.8.4.4.project cabal.8.6.2.project
build: build-7.8.4 build-7.10.3 build-8.0.2 build-8.2.2 build-8.4.4 build-8.6.2
test: test-7.8.4 test-7.10.3 test-8.0.2 test-8.2.2 test-8.4.4 test-8.6.2
deps: deps.7.8.4.png deps.7.10.3.png deps.8.0.2.png deps.8.2.2.png deps.8.4.4.png deps.8.6.2.png
...
build-8.6.2: cabal.8.6.2.project
	cabal new-build --builddir=dist-newstyle-8.6.2 --project-file cabal.8.6.2.project -w ghc-8.6.2 --disable-tests --disable-benchmarks all
...
cabal.8.4.4.project: cabal.darkmatter
	darkmatter
cabal.8.6.2.project: cabal.darkmatter
	darkmatter
...
deps.8.6.2.png: cabal.8.6.2.project
	cabal new-build --builddir=dist-newstyle-8.6.2 --project-file cabal.8.6.2.project -w ghc-8.6.2 --disable-tests --disable-benchmarks all --dry-run
	cabal-plan --builddir=dist-newstyle-8.6.2 --hide-builtin --hide-global dot --tred --tred-weights | dot -Tpng -odeps.8.6.2.png
...
test-8.6.2: cabal.8.6.2.project
	cabal new-build --builddir=dist-newstyle-8.6.2 --project-file cabal.8.6.2.project -w ghc-8.6.2 --enable-tests --disable-benchmarks all
	cabal new-test --builddir=dist-newstyle-8.6.2 --project-file cabal.8.6.2.project -w ghc-8.6.2 --enable-tests --disable-benchmarks all
