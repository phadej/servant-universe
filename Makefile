project-files: cabal.8.0.2.project cabal.8.2.2.project cabal.8.4.4.project cabal.8.6.5.project cabal.8.8.1.project
Makefile: cabal.darkmatter
	darkmatter > Makefile
build: build-8.0.2 build-8.2.2 build-8.4.4 build-8.6.5 build-8.8.1
test: test-build test-8.0.2 test-8.2.2 test-8.4.4 test-8.6.5 test-8.8.1
test-build: test-dry test-build-8.0.2 test-build-8.2.2 test-build-8.4.4 test-build-8.6.5 test-build-8.8.1
test-dry: test-dry-8.0.2 test-dry-8.2.2 test-dry-8.4.4 test-dry-8.6.5 test-dry-8.8.1
deps: deps-8.0.2.png deps-8.2.2.png deps-8.4.4.png deps-8.6.5.png deps-8.8.1.png
